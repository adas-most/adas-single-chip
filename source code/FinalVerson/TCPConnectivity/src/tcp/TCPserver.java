...
import tcp.service.GetFileService;
import tcp.service.Update;
import tcp.service.GetDeviceStateService;
...
{
    private int port = Settings.CONNECT_PORT;
...
class RequestThread implements Runnable
{
    ...
    * @throws ClassNotFoundException 
     ...
     * @throws NumberFormatException, IOException
     */
    private Map<String, Object> handleAction(Map<String, Object> request) throws ClassNotFoundException, SQLException
    {
        ...
        switch(requestActionCode)
        {
            ...
            case Settings.ActionCode.getFile:
            {
            ...
            case Settings.ActionCode.getDeviceState:
            {
            ...
            case Settings.ActionCode.update:
            {
            	Update getUpdate = new Update(request);

            	ServiceState = getUpdate.implement();

                if(ServiceState) 
                {
                	response = getUpdate.getResponse(); 
                }
                else
                {
                    response.put("error", "Server receive fail !!");
