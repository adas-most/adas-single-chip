...
public class TreatmentGen {
	...
	public static void main(String[ ] args) throws JSONException, ClassNotFoundException, SQLException {
		...
		String query = "drop table if exists test.treatment;";
		
		dam.impalaSqlCommand(query, 2);
		System.out.println("Query : " + query);
		query = "create table test.treatment(eventid String,eventtype String,treatment String);";
		dam.impalaSqlCommand(query, 2);
		System.out.println("Query : " + query);
